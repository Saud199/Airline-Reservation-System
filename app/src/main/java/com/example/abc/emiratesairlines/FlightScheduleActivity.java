...
public class FlightScheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flightList = (ListView) findViewById(R.id.scheduledflight_list);
        counter = (TextView) findViewById(R.id.flight_info_status);
    ...
    public void viewFlights() {
        ...
        ref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                final ArrayAdapter<String> adapter = new ArrayAdapter<String>(FlightScheduleActivity.this, android.R.layout.simple_list_item_1, flightnames);
